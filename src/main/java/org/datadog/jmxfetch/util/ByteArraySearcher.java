...
/**
 * Employs the literal version of the Bitap/shift-and algorithm to match short search terms in
 * worst-case linear time.
 *
 * <p>The masks are bit-sliced to reduce spatial requirement from ~2KB per matcher to ~256 bytes.
 */
