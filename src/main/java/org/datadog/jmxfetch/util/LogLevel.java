...
/**
 * LogLevel used for internal logging to match Datadog Agent levels. Comparison table with
 * java.util.logging:
 *
 * <pre>
 ...
 * </pre>
 *
 * <p>`FATAL` from previous bindings used by JMXFetch is now converted to `LogLevel.ERROR`.
 */
public enum LogLevel {
  ...
  /**
   * toJulLevel converts a LogLevel to a `java.util.logging.Level`. This mapping needs to match
   * http://slf4j.org/api/org/slf4j/impl/JDK14LoggerAdapter.html
   */
