...
public class TestReconnectContainer extends TestCommon {
  ...
  private static ImageFromDockerfile img =
      new ImageFromDockerfile().withFileFromPath(".", Paths.get("./tools/misbehaving-jmx-server/"));

  @Rule(order = 0)
  public GenericContainer<?> cont =
          ...
          return new Statement() {
            ...
            public void evaluate() throws Throwable {
              ...
              try {
                ...
                log.warn(
                    "Supervisor call to set rmi hostname failed, tests may fail in some environments, e: ",
                    e);
              }
              base.evaluate();
            }
  ...
  public void testJMXDirectBasic() throws Exception {
    ...
    String remoteJmxServiceUrl =
        String.format("service:jmx:rmi:///jndi/rmi://%s:%s/jmxrmi", ipAddress, rmiPort);
  ...
  public void testJMXFetchBasic() throws IOException, InterruptedException {
    ...
    List<Map<String, Object>> metrics =
        ((ConsoleReporter) this.appConfig.getReporter()).getMetrics();
