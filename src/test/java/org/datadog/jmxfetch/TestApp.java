...
public class TestApp extends TestCommon {
  ...
  public void testClassExclude() throws Exception {
    ...
    registerMBean(new SimpleTestJavaApp(), "org.datadog.jmxfetch.includeme:type=AType");
    registerMBean(
        new SimpleTestJavaAnotherApp(), "org.datadog.jmxfetch.includeme2:type=AnotherType");
  ...
  public void testClassRegex() throws Exception {
    ...
    registerMBean(
        new SimpleTestJavaAppIncludeMeToo(), "org.datadog.jmxfetch.includeme.too:type=AType");
    registerMBean(
        new SimpleTestJavaAppIncludeMeNotMeX(), "org.datadog.jmxfetch.includeme.not.me:type=AType");
  ...
  public void testExcludeServiceTagsAndOverride() throws Exception {
    ...
    List<String> commonTags =
        Arrays.asList(
            "instance:jmx_test_service_override_instance",
            "jmx_domain:org.datadog.jmxfetch.test",
            "service:test");
  ...
  /**
   * Test that when a metric fails to be fetched and there is no default for it, that metric is
   * ignored while others still get fetched
   */
  @Test
