...
public class ConfigServiceNameProviderTest {
  ...
  public ConfigServiceNameProviderTest(
  ...
  public void testConfigServiceNameProvider() {
    ConfigServiceNameProvider configServiceNameProvider =
        new ConfigServiceNameProvider(instanceMap, initConfigMap, provider);
