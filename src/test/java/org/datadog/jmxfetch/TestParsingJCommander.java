...
public class TestParsingJCommander {
  ...
  public void testParsingLogLevel() {
    ...
    try {
      ...
      assertEquals(
          "Parameter --log_level should be in (ALL,DEBUG,ERROR,FATAL,INFO,OFF,TRACE,LEVEL,WARN)",
          pe.getMessage());
    }
  }
  ...
  public void testParsingCheckPeriod() {
    ...
    try {
      ...
      assertEquals(
          "Parameter --check_period should be an integer (found not_a_number)", pe.getMessage());
    }
